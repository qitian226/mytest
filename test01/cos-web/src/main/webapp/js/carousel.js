  ...
  Carousel.prototype = {
       ...
       setSettingValue:function(){
         ...
         /*  this.nextBtn.css({
                 width:w,
                 height:this.setting.height,
                 zIndex:Math.ceil(this.posterItem.length/2)
           });
           this.prevBtn.css({
                 width:w,
                 height:this.setting.height,
       ...
       setPosterPos:function(){
           ...
           var sliceItem = this.posterItem.slice(1),
               ...
               level = Math.floor(this.posterItem.length/2);
           ...
           rightSlice.each(function(i){
            ...
            var leftSliceSize = leftSlice.length;
            var oloop = leftSlice.length;
       ...
       autoPlay:function(){
       	  ...
       	  this.timer = window.setInterval(function(){
       		if(_this_.animateStopFlag){
       			_this_.animateStopFlag = false;
