var polaroidGallery = (function () {
    ...
    function setGallery(arr) {
        ...
        for (i = 0; i < arr.length; i++) {
            out += "<figure id=\"" + i + "\">" +
                "<img src=\"../topic/image/s/"+arr[i].id+".jpg\" alt=\"" + arr[i].title + "\"/>" +
                "<figcaption><a href=\"../topic/"+arr[i].classify+"/"+arr[i].id+".html\" target=\"_blank\">" + arr[i].title + "</a></figcaption>" +
                "</figure>";
        }
    ...
    function select(item) {
        ...
        var y = ((window.innerHeight - navbarHeight - newHeight) / 2)+20;
    ...
    function shuffle(item, zIndex) {
        ...
        var y = Math.floor((window.innerHeight - rotatedH) * randomY+100);
